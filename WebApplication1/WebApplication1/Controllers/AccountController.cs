        ...
        public async Task<ActionResult> Register(Users model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    try
                    {
                        Models.MongoDBHelper.MongoDBConnectionService();
                        Models.MongoDBHelper.users_collection = Models.MongoDBHelper.database.GetCollection<Models.Users>("users");

                        var id = user.Id;

                        Models.MongoDBHelper.users_collection.InsertOne(new Models.Users
                        {
                            _id = id,
