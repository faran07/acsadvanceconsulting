...
namespace WebApplication1.Controllers
{
    ...
    public class ManageController : Controller
    {
        ...
        public async Task<ActionResult> Index(ManageMessageId? message)
        {
            ...
            var allTupleData = new Tuple<IndexViewModel, Users>(model, userModel);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> AddCampaign(Campaigns model)
        {
            if (ModelState.IsValid)
            {
                try
                {
                    ...
                    if (model.ImageFile.ContentType != "image/png" || model.ImageFile.ContentType != "image/jpeg" || model.ImageFile.ContentType != "image/jpg")
                    {
                        ...
                        if (model.ImageFile.ContentLength <= 15000000)
                        {
                            ...
                            Models.MongoDBHelper.campaigns_collection = Models.MongoDBHelper.database.GetCollection<Models.Campaigns>("campaigns");

                            string userId = User.Identity.GetUserName();
                            Object id = Guid.NewGuid().ToString();
                            string FileName = Path.GetFileName(model.ImageFile.FileName);

                            Models.MongoDBHelper.campaigns_collection.InsertOne(new Models.Campaigns
                            {
                                id = id,
                                title = model.title,
        ...
        public ActionResult AddSmallBusiness()
        {
            return View();
        }
        ...
        /*public ActionResult ApproveCampaign()
        {
            return View();
        }*/

        public ActionResult ApproveCampaign(Campaigns model)
        {
            object i = model.id;
            Models.MongoDBHelper.MongoDBUpdateCampaign(i, "Approved");
        ...
        public ActionResult ApproveSmallBusiness(SmallBusinesses model)
        {
            object i = model.id;
            Models.MongoDBHelper.MongoDBUpdateSmallBusiness(i, "Approved");
            return RedirectToAction("ViewRequests", new { Message = ManageMessageId.UpdatedRequestSuccess });
        }
